...
public class StartGame extends Application{
    ...
    public void start(Stage stage) throws Exception {
        ...
        Rectangle2D primaryScreenBounds = Screen.getPrimary().getVisualBounds(); // Bildschirmgrösse
        //width = (int)primaryScreenBounds.getWidth() - 400;
        width = (int)primaryScreenBounds.getWidth();
        //height = (int)primaryScreenBounds.getHeight() - 400;
        height = (int)primaryScreenBounds.getHeight();
                
        manager = new Manager(this); //->Screenmanager 
