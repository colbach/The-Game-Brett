 ...
 * @author Korè
 */
public class MADNstartField extends MADNfield{
    
    public MADNstartField(double width, double height, RelativePoint position, MADNfield[] next, Layout layout, MediaEffect me) {
